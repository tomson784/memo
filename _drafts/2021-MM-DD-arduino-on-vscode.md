...
```json
{
    ...
    "sketch": "コンパイル対象のArduinoファイルの相対パス",
    // "programmer": "arduino:avrispmkii" // これはなくても大丈夫だった気がする．
}
```

`c_cpp_properties.json`は以下のものが自動生成された（verifyしたとき）  
`/home/<user name>/arduino-1.8.13`に関しては人それぞれなので個別対応となる．
...
```json
{
    ...
    "configurations": [
        {
            "name": "Arduino",
            "compilerPath": "/home/<user name>/arduino-1.8.13/hardware/tools/avr/bin/avr-g++",
            "compilerArgs": [
                "-std=gnu++11",
                "-fpermissive",
                "-fno-exceptions",
            ...
            "includePath": [
                "/home/<user name>/arduino-1.8.13/hardware/arduino/avr/cores/arduino",
                "/home/<user name>/arduino-1.8.13/hardware/arduino/avr/variants/mega",
                "/home/<user name>/arduino-1.8.13/hardware/tools/avr/lib/gcc/avr/7.3.0/include",
                "/home/<user name>/arduino-1.8.13/hardware/tools/avr/lib/gcc/avr/7.3.0/include-fixed",
                "/home/<user name>/arduino-1.8.13/hardware/tools/avr/avr/include"
            ],
            "forcedInclude": [
                "/home/<user name>/arduino-1.8.13/hardware/arduino/avr/cores/arduino/Arduino.h"
            ],
            "cStandard": "c11",
            "cppStandard": "c++11",
            "defines": [
